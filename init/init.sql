...
/* members data */
INSERT INTO members(id,first_name,last_name,introduction,email,photo_id) VALUES (1,'admin', 'istration','admin is the president of the club.....etc','admin@cornell.edu',1);
/*member images data*/
